import { B as HalfFloatType, Ct as NearestFilter, Dt as Object3D, E as DataTexture, Et as NumberKeyframeTrack, F as FileLoader, Ft as Points, Gt as RepeatWrapping, H as ImageBitmapLoader, It as PointsMaterial, J as InterleavedBufferAttribute, K as InstancedMesh, Kt as SRGBColorSpace, L as FloatType, Lt as PropertyBinding, O as DataUtils, Pt as PointLight, Qt as Sphere, Rt as Quaternion, S as CompressedTexture, St as MirroredRepeatWrapping, Tt as NearestMipmapNearestFilter, U as ImageUtils, Vt as RGBAFormat, W as InstancedBufferAttribute, X as InterpolateDiscrete, Xt as Skeleton, Y as Interpolant, Z as InterpolateLinear, Zt as SkinnedMesh, _n as VectorKeyframeTrack, an as TextureSource, at as LinearMipmapLinearFilter, b as Color, bt as MeshPhysicalMaterial, c as AnimationClip, ct as Loader, d as Box3, dt as Material, et as Line, f as BoxGeometry, ft as MathUtils, gt as MeshBasicMaterial, hn as Vector3, ht as Mesh, i as UniformsLib, in as TextureLoader, it as LinearFilter, j as DirectionalLight, jt as PerspectiveCamera, kt as OrthographicCamera, lt as LoaderUtils, m as BufferGeometry, mn as Vector2, mt as Matrix4, nt as LineLoop, ot as LinearMipmapNearestFilter, p as BufferAttribute, q as InterleavedBuffer, qt as Scene, rn as Texture, rt as LineSegments, st as LinearSRGBColorSpace, tn as SpotLight, tt as LineBasicMaterial, u as Bone, v as ClampToEdgeWrapping, wt as NearestMipmapLinearFilter, x as ColorManagement, xt as MeshStandardMaterial, z as Group, zt as QuaternionKeyframeTrack } from "./monogrid__gainmap-js+three.mjs";
...
function mergeVertices(geometry, tolerance = 1e-4) {
	...
	for (let i = 0; i < vertexCount; i++) {
		...
		for (let j = 0, l = attributeNames.length; j < l; j++) {
			...
			for (let k = 0; k < itemSize; k++) hash += `${Math.trunc(attribute[getters[k]](index) * hashMultiplier + hashAdditive)},`;
		}
...
//#endregion
export { mergeGeometries as a, RoundedBoxGeometry as i, GLTFLoader as n, mergeVertices as o, GLTFExporter as r, RectAreaLightUniformsLib as t };
