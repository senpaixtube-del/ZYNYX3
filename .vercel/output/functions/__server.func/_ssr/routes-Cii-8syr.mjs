...
import { $t as SphereGeometry, At as Path, C as ConeGeometry, I as Float32BufferAttribute, M as Euler, Nt as PlaneGeometry, P as ExtrudeGeometry, Q as LatheGeometry, Rt as Quaternion, T as CylinderGeometry, V as IcosahedronGeometry, Yt as Shape, _ as CatmullRomCurve3, cn as TubeGeometry, f as BoxGeometry, g as CapsuleGeometry, hn as Vector3, ht as Mesh, jt as PerspectiveCamera, m as BufferGeometry, mn as Vector2, mt as Matrix4, on as TorusGeometry, p as BufferAttribute, sn as TorusKnotGeometry, xt as MeshStandardMaterial, z as Group } from "../_libs/monogrid__gainmap-js+three.mjs";
import { a as mergeGeometries, i as RoundedBoxGeometry, n as GLTFLoader, o as mergeVertices, r as GLTFExporter } from "../_libs/three.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Cii-8syr.js
...
function exportSceneGlb(filename = "zynyx.glb") {
...
function AddShelf() {
	const lang = useStudio((s) => s.lang);
	const prims = Object.keys(PRIMITIVE_DEFAULTS).filter((k) => k !== "baked");
	const gens = [
		"gear",
		"stairs",
		"helix",
...
var Viewport = (0, import_react.lazy)(() => import("./Viewport-BccreeUe.mjs").then((m) => ({ default: m.Viewport })));
...
function StudioApp() {
	...
	(0, import_react.useEffect)(() => {
		...
		if (saved?.objects?.length) useStudio.getState().hydrate({
...
//#endregion
export { useStudio as a, evalObjectAtFrame as i, registerCapture as n, evaluateGeometry as o, captureRender as r, geometrySignature as s, routes_exports as t };
